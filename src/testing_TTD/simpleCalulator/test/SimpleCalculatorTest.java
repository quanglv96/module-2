package testing_TTD.simpleCalulator.test;
...
public class SimpleCalculatorTest {
    ...
    @Test
    @DisplayName("Testing add book1 + 0")
    ...
    @Test
    @DisplayName("Testing add 0 + book1")
    ...
    @Test
    @DisplayName("Testing sub book1 - 0")
    ...
    @Test
    @DisplayName("Testing sub 0 - book1")
